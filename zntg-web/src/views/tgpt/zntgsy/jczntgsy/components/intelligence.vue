  ...
  <div class="intelligence">
    <div class="intelligence-main">
      ...
      <div class="intelligence-con">
        ...
        <div
          v-if="chackArr[intelligenceActive].property.length > 0"
          :class="[
            'intelligence-checkbox',
            chackArr[intelligenceActive].name === '强化学习' ? 'checkbox-con_active' : '',
          ]"
        >
          <div
            ...
            :class="[
              'checkbox-con',
              !isNotPlainObject(item[item.value]) ? 'checkbox-strengthen' : '',
            ]"
          >
            ...
            <el-input
              v-if="isNotPlainObject(item[item.value])"
              v-model="item[item.value]"
              style="width: 480px"
              :placeholder="item.commit"
            />
