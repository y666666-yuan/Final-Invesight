  ...
  <div class="intelligence">
    <div class="intelligence-main">
      <div class="intelligence-title">
        ...
        <div class="intelligence-name">约束条件配置</div>
      </div>
      <div class="intelligence-con">
        <div class="con-name">
          ...
          <div class="con-list">
            <div
              v-for="(item, index) in chackArr[0].constraint"
              :key="index"
        ...
        <div class="con-name">
          <p>*</p>
          <p>{{ chackArr[0].constraint[intelligenceActive].label }}：</p>
          <div class="con-list">
            <el-select
              v-model="chackArr[0].constraint[intelligenceActive][chackArr[0].constraint[intelligenceActive].value]"
              multiple
              collapse-tags
              :max-collapse-tags="8"
              placeholder=""
            ...
            >
              <el-option
                v-for="(item, index) in chackArr[0].constraint[intelligenceActive].default_value"
                :key="index"
                :label="item.label"
                :value="item.value"
              />
...
const handleList = (num) => {
  ...
  state.chackArr[0].constraint.map((item, index) => {
    if (index === num) {
      item.bol = true;
    } else {
      item.bol = false;
...
const handleStep = (num) => {
  if (num === 3) {
    ...
    state.chackArr[0].constraint[intelligenceActive.value].bol = true;
    let chackArrBol = true;
    if (state.chackArr[0].constraint[intelligenceActive.value][state.chackArr[0].constraint[intelligenceActive.value].value].length === 0) {
      chackArrBol = false;
    }
    if (chackArrBol) {
