        ...
        "constraint": [
            {
                "label": "利率",
                "value": "apr_percent",
                "commit": "按照相关特征升序排序，前25%；25%-50%；50%-75%；75%-100%",
            ...
            },
            {
                "label": "还款方式",
                "value": "REPAYMENT",
                "commit": "0：等额本息，1：一次性还本付息，2：月还息，季还1/4本金",
...
ALGORITHM_NEW_INVESTOR_COLD_RUN_MISS = 'cold-run-miss'
ALGORITHM_NEW_INVESTOR_COLD_RUN_COLD = 'cold-run-cold'
ALGORITHM_NEW_INVESTOR_NAMES = [ALGORITHM_NEW_INVESTOR_COLD_RUN, ALGORITHM_NEW_INVESTOR_COLD_RUN_MISS,
                                ALGORITHM_NEW_INVESTOR_COLD_RUN_COLD]
...
ALGORITHM_EXPLAIN_GCN = "gcn"
ALGORITHM_EXPLAIN_NAMES = [ALGORITHM_EXPLAIN_GCN]

ALGORITHM_EXPLAIN_PARAMS = [{
    "name": "Logit-lightGCN",
    "value": "gcn",
    "property": [
